...
Battery_ReadyGame:
    ...
    ld [rRAMB], a
    Battery_On
    ld a, [xBattery_SavedSavefileBaseBank]                                 ; $4019: $FA $00 $A0
    ld b, a                                       ; $401C: $47
    and a                                         ; $401D: $A7
    ...
    ld a, b                                       ; $402A: $78
    ld [xBattery_SavedSavefileBaseBank], a                                 ; $402B: $EA $00 $A0
    ld d, a                                       ; $402E: $57
    ld a, b                                       ; $402F: $78
    xor $02                                       ; $4030: $EE $02
    ld e, a                                       ; $4032: $5F
...
Battery_CopyBank:
    ...
    call Battery_Copy1000Bytes                            ; $404C: $CD $6C $40
    inc e                                         ; $404F: $1C
    inc d                                         ; $4050: $14
    ret                                           ; $4051: $C9
...
jr_007_4052:
    ...
    call Battery_Copy1000Bytes                            ; $405C: $CD $6C $40
    inc e                                         ; $405F: $1C
    inc d                                         ; $4060: $14
    ret                                           ; $4061: $C9
...
jr_007_4062:
    ...
    call Battery_Copy1000Bytes                            ; $4065: $CD $6C $40
    inc e                                         ; $4068: $1C
    inc d                                         ; $4069: $14
    ret                                           ; $406A: $C9
...
Battery_LoadGame:
    ...
    ld a, $02                                     ; $40EA: $3E $02
    ld [xBattery_SavedSavefileBaseBank], a                                 ; $40EC: $EA $00 $A0
...
Battery_SaveGame:
    ...
    ld a, $00                                     ; $4117: $3E $00
    ld [xBattery_SavedSavefileBaseBank], a                                 ; $4119: $EA $00 $A0
    xor a                                         ; $411C: $AF
